...
- (void)viewDidLoad {
  ...
  CFRunLoopTimerRef timer = CFRunLoopTimerCreate(
      kCFAllocatorDefault, 0.1, 0.001, 0, 0, &myCFTimerCallback, &context);
  CFRunLoopTimerContext packContext = {0, self, NULL, NULL, NULL};
  CFRunLoopTimerRef packTimer = CFRunLoopTimerCreate(
      kCFAllocatorDefault, 0.1, 0.5, 0, 0, &cfPackMesh, &packContext);
  CFRunLoopAddTimer(runLoop, timer, kCFRunLoopCommonModes);
  CFRunLoopAddTimer(runLoop, packTimer, kCFRunLoopCommonModes);
}
