...
void AddWireFrameTriangle(float*& current, const Vec3f& apos, const Vec3f& bpos,
                          const Vec3f& cpos, const Vec3f& anormal,
                          const Vec3f& bnormal, const Vec3f& cnormal,
                          const Vec3f& color, const Vec3f& abcolor,
                          const Vec3f& bccolor, const Vec3f& cacolor);

void AddQuad(float*& current, const Vec3f& apos, const Vec3f& bpos,
             const Vec3f& cpos, const Vec3f& dpos, const Vec3f& normal,
             const Vec3f& color);

void AddBox(float*& current, const Vec3f pos[8], const Vec3f& color);
